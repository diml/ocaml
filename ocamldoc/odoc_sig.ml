        ...
        | Parsetree.Psig_type (rf, name_type_decl_list) ->
            let extended_env =
              List.fold_left
                ...
                name_type_decl_list
            in
            let equation_env = (* environment for the equation part *)
              match rf with
            ...
            let rec f ?(first=false) acc_maybe_more last_pos name_type_decl_list =
              ...
              | type_decl :: q ->
                  ...
                  let type_kind = get_type_kind extended_env name_comment_list sig_type_decl.Types.type_kind in
                  ...
                  let new_type =
                    {
                      ...
                      ty_parameters =
                        List.map2 (fun p v ->
                          ...
                          (Odoc_env.subst_type equation_env p,co, cn))
                      ...
                      ty_manifest =
                        ...
                        | None   -> None
                        | Some t ->
                          Some (manifest_structure equation_env name_comment_list t)
                        end ;
